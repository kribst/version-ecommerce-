...
from .views import SiteSettingsViewSet, ProductCarouselViewSet, ProductPromotionViewSet, FeaturedPromotionViewSet, \
    CategoryViewSet, NewProductsViewSet, ParametrePageViewSet, MainFlashProductViewSet, SecondaryFlashProductViewSet, ProductSearchViewSet, ProductDetailViewSet, CommentaireViewSet, ProductCommentairesViewSet
