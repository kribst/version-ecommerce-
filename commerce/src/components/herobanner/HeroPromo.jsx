...
export default function HeroPromo() {
  ...
  if (loading) {
    return (
      <div className={`relative h-[420px] flex items-center justify-center bg-gray-900/5 ${styles.promoContainer}`}>
  ...
  return (
    <div className={`relative h-[420px] overflow-hidden ${styles.promoContainer}`}>
      {/* Image produit (img classique) */}
      <img
        src={promo.product_image}
        alt={promo.product_name}
        className="absolute inset-0 w-full h-full object-cover"
        onError={(e) => {
          e.currentTarget.src = "/img/laptop.png";
        }}
      />
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-white px-4 w-full">
        <span className="text-[11px] tracking-[0.25em] opacity-80 uppercase">
          Promotion
        </span>
