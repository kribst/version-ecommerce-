  ...
  useEffect(() => {
    ...
    const fetchCategoryProducts = async () => {
      try {
        ...
        const response = await getCategoryProducts(categorySlug, currentPage);
        const { results, count, page, page_size, total_pages, has_next, has_previous, category: categoryData } = response || {};

        // Sauvegarder les informations de la catégorie
        if (categoryData) {
